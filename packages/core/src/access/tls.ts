 ...
 * every sandbox hostname on the machine as well. Nothing sandboxer serves is deeper than this, and nothing may
...
export async function writeCertificateEntry(
  ...
  await writeFile(
    path,
    [
      "# Generated by sandboxer. Edits are lost on the next run.",
      "tls:",
      ...(options.isDefault
