...
Seven pages, each answering one kind of question. Nothing here explains how sandboxer works; the
...
| [What is built](status.md) | The honest inventory: what has been run for real, and what has not |
...
**Next:** [Cheat sheet](cheat-sheet.md) for the facts, or [What is built](status.md) before you rely
on anything.
