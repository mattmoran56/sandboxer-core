...
| [One repo, many branches](one-repo-many-worktrees.md) | Every branch of one project running at once, out of worktrees you already keep | Memory, mostly. And a name collision if two worktrees mention the same ticket | One repository, with git worktrees cut from it |
